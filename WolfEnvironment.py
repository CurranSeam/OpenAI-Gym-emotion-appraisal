...
class WolfDifferentRewardsEnv(discrete.DiscreteEnv):
    ...
    Observations: 
    There are 135 discrete states since there are 3 rows, 5 columns, 
    3 locations for the rabbit, and 3 locations for the hare. 
                        ...
                        for action in range(num_actions):
                            ...
                            if action == 2 and self.desc[1 + row, 2 * col + 2] == b":":
                                ...
                                if (taxi_loc == locs[pass_idx1]):
                                    ...
                                    reward = 0.1
                                    #reward = 20
                                    #locs.remove(taxi_loc)
                                elif (taxi_loc == locs[pass_idx2]):
                                    done = True
                                    reward = 1
                                    #locs.remove(taxi_loc)
