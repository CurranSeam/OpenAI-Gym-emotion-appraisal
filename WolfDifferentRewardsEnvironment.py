...
class WolfDifferentRewardsEnv(discrete.DiscreteEnv):
    """
    Wolf Simulation
    ...
    The wolf navigates to the animal's locations then eats the prey. Once the prey is eaten, the episode ends.
    
    Observations: 
    There are 15 discrete states since there are 3 rows, 5 columns, 
    1 location for the rabbit, and 1 location for the hare. 
    ...
    def __init__(self):
        ...
        self.locs1 = locs1 = [(0,4)]
        self.locs2 = locs2 = [(0,0)]
                    ...
                    for pass_idx2 in range(len(locs2)):
                        ...
                        for action in range(num_actions):
                            ...
                            if ((new_row, new_col) == locs1[pass_idx1]):
                                ...
                                reward = 1
                            elif ((new_row, new_col) == locs2[pass_idx2]):
                                done = True
                                reward = 0.1
                            if state in [1, 3, 6, 8]:
    ...
    def render(self, mode='human'):
        ...
        out[1 + p1i][2 * p1j + 1] = utils.colorize(out[1 + p1i][2 * p1j + 1], 'green', highlight=True)
        p2i, p2j = self.locs2[pass_idx2]
        out[1 + p2i][2 * p2j + 1] = utils.colorize(out[1 + p2i][2 * p2j + 1], 'cyan', highlight=True)
        '''
